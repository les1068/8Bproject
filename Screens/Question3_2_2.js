...
const Question3_2_2 = ({route,navigation}) =>{
  const [answer,setAnswer] = useState('')
  const {nickname} = route.params;
  const qid = "sub_question3_2_2"
  const solved = true;
    return(
      ...
      <View style={styles.inputView}>
        ...
        navigation.navigate("SelectStrategy3",{nickname:nickname, solved1:solved, solved2:solved})
        }}>
